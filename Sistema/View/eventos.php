...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_SESSION['participante_id'])) {
        ...
        window.location.href = 'loginParticipante.php';
    </script>";
        exit;
    }
}
...
<body>
   ...
   <header>
    ...
    if (isset($_SESSION['participante_id'])) {
        ...
        echo "<p><a href='cadastrarParticipante.php'>Cadastre-se</a></p> <p>ou</p> <p><a href='loginParticipante.php'>Faça login</a></p>";
    }
    ?>
    </div>
</header>
    ...
    <main>
        <section class="secao">
            <h2>Eventos</h2>
            <p class="texto-a-parte">Aqui você pode encontrar todos os eventos organizados pela Kondo Eventos. Explore as opções e participe dos eventos que mais lhe interessam! Ou, se preferir, <a href="criarEvento.php">crie seu próprio evento</a>.</p>
        </section> <br><br>
        ...
        if (empty($eventos)) {
            ...
            foreach ($eventos as $evento) {
                ...
                if ($vagasDisponiveis > 0) {
                    ...
                    echo "<input type='submit' value='Participar' class='btns'>";
                    echo "</form>";
                } elseif ($vagasDisponiveis == 0) {
                    echo "<p><em>Evento lotado</em></p>";
                }
                if (isset($_SESSION['email']) && $_SESSION['email'] == 'adm@gmail.com') {
                    echo "<a href='editarEvento.php?id=" . $evento['id'] . "' class='btns'>Editar Evento</a>";
                    echo "<br>";
                    echo "<a href='BEpages/deletarEvento.php?id=" . $evento['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este evento?\")' class='btns'>Excluir Evento</a>";
                }
                echo "</div>";
                echo "<br>";
            }
